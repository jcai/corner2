...
public class RelativePersistentBasicTableModel<T> implements IBasicTableModel{
	...
	public RelativePersistentBasicTableModel(EntityService entityService,T rootedObj,String relativeProName){
			...
			rows=((Integer) ((HibernateObjectRelativeUtils) this.entityService
					...
					.execute(new HibernateCallback(){
						...
						public Object doInHibernate(Session session) throws HibernateException, SQLException {
							Query query=session.createFilter(getRelativeCollection(),"select count(*)");
		...
		return((Iterator) ((HibernateObjectRelativeUtils) this.entityService
				...
				.execute(new HibernateCallback(){
					...
					public Object doInHibernate(Session session) throws HibernateException, SQLException {
						...
						Query query=session.createFilter(getRelativeCollection(),orderStr);
