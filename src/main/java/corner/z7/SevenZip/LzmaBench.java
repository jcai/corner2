...
public class LzmaBench {
    ...
    static public int LzmaBenchmark(int numIterations, int dictionarySize)
        ...
        corner.z7.SevenZip.Compression.LZMA.Encoder encoder = new corner.z7.SevenZip.Compression.LZMA.Encoder();
        corner.z7.SevenZip.Compression.LZMA.Decoder decoder = new corner.z7.SevenZip.Compression.LZMA.Decoder();
        ...
        int kCompressedBufferSize = (kBufferSize / 2) +
        ...
        corner.z7.Common.CRC crc = new corner.z7.Common.CRC();
        crc.Init();
        ...
        public void Generate() {
            ...
            while (Pos < BufferSize) {
                if ((GetRndBit() == 0) || (Pos < 1)) {
                    ...
                    for (int i = 0; (i < len) && (Pos < BufferSize);
                            i++, Pos++)
