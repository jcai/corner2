...
public class CoderInfo {
    ...
    static public void SetSizes(LongVector srcSizes, LongVector sizes,
        LongVector sizePointers, int numItems) {
        sizes.clear();
        sizePointers.clear();
    ...
    public void SetCoderInfo(LongVector inSizes, //  const UInt64 **inSizes,
