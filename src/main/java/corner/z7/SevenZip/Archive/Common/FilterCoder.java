...
public class FilterCoder extends java.io.OutputStream implements ICompressCoder,
    ...
    public corner.z7.SevenZip.ICompressFilter Filter = null;
    ...
    public int Code(java.io.InputStream inStream, // , ISequentialInStream
        ...
        long outSize, corner.z7.SevenZip.ICompressProgressInfo progress)
    ...
    void WriteWithLimit(java.io.OutputStream outStream, int size)
        throws IOException {
