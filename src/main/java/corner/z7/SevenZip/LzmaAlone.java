...
import corner.z7.SevenZip.Compression.LZMA.Decoder;
import corner.z7.SevenZip.Compression.LZMA.Encoder;
...
public class LzmaAlone {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (params.Command == CommandLine.kBenchmak) {
            ...
            corner.z7.SevenZip.LzmaBench.LzmaBenchmark(params.NumBenchmarkPasses,
                dictionary);
            ...
            java.io.BufferedInputStream inStream = new java.io.BufferedInputStream(new java.io.FileInputStream(
                        inFile));
            java.io.BufferedOutputStream outStream = new java.io.BufferedOutputStream(new java.io.FileOutputStream(
                        outFile));
