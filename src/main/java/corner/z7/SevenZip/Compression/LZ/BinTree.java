// LZ.BinTree
package corner.z7.SevenZip.Compression.LZ;
...
public class BinTree extends InWindow {
    ...
    public int GetMatches(int[] distances) throws IOException {
        ...
        int offset = 0;
        int matchMinPos = (_pos > _cyclicBufferSize) ? (_pos -
            _cyclicBufferSize) : 0;
        ...
        while (true) {
            ...
            if ((_bufferBase[pby1 + len] & 0xFF) < (_bufferBase[cur + len] &
                    0xFF)) {
                _son[ptr1] = curMatch;
                ptr1 = cyclicPos + 1;
                curMatch = _son[ptr1];
    ...
    public void Skip(int num) throws IOException {
        do {
            ...
            int matchMinPos = (_pos > _cyclicBufferSize)
            ...
            if (HASH_ARRAY) {
                ...
                _hash[kHash3Offset + hash3Value] = _pos;
                hashValue = (temp ^
                    (CrcTable[_bufferBase[cur + 3] & 0xFF] << 5)) & _hashMask;
            } else {
                hashValue = ((_bufferBase[cur] & 0xFF) ^
                    ((int) (_bufferBase[cur + 1] & 0xFF) << 8));
            }
