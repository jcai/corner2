...
import corner.z7.SevenZip.Compression.LZ.OutWindow;
import corner.z7.SevenZip.Compression.LZMA.Base;
import corner.z7.SevenZip.Compression.RangeCoder.BitTreeDecoder;
import corner.z7.SevenZip.HRESULT;
...
// OLD CODE public class Decoder implements corner.z7.SevenZip.ICompressCoder , corner.z7.SevenZip.ICompressSetDecoderProperties2
public class Decoder extends java.io.InputStream // _ST_MODE
    implements corner.z7.SevenZip.ICompressCoder,
        corner.z7.SevenZip.ICompressSetDecoderProperties2,
        corner.z7.SevenZip.ICompressGetInStreamProcessedSize,
        // #ifdef _ST_MODE
        corner.z7.SevenZip.ICompressSetInStream,
        corner.z7.SevenZip.ICompressSetOutStreamSize// #endif
 {
    static final int kLenIdFinished = -1;
    static final int kLenIdNeedInit = -2;
    OutWindow m_OutWindow = new OutWindow();
    corner.z7.SevenZip.Compression.RangeCoder.Decoder m_RangeDecoder = new corner.z7.SevenZip.Compression.RangeCoder.Decoder();
    ...
    public int ReleaseInStream() throws IOException {
        ...
        return corner.z7.SevenZip.HRESULT.S_OK;
    }

    public int SetInStream(java.io.InputStream inStream) { // corner.z7.Common.ISequentialInStream
    ...
    public int SetOutStreamSize(long outSize /* const UInt64 *outSize*/) {
        _outSizeDefined = (outSize != corner.z7.SevenZip.ICompressSetOutStreamSize.INVALID_OUTSIZE);
    ...
    public int read(byte[] data, int off, int size) throws IOException {
        if (off != 0) {
            throw new java.io.IOException(
                "LZMA Decoder - read(byte [] data, int off != 0, int size)) not implemented");
        }
    ...
    void Init() throws IOException {
        ...
        corner.z7.SevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_IsMatchDecoders);
        corner.z7.SevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_IsRep0LongDecoders);
        corner.z7.SevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_IsRepDecoders);
        corner.z7.SevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_IsRepG0Decoders);
        corner.z7.SevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_IsRepG1Decoders);
        corner.z7.SevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_IsRepG2Decoders);
        corner.z7.SevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_PosDecoders);
    ...
    public int CodeReal(java.io.InputStream inStream, // , ISequentialInStream
        java.io.OutputStream outStream, // ISequentialOutStream
        long outSize, ICompressProgressInfo progress // useless_progress
    ) throws IOException {
    ...
    public int Code(java.io.InputStream inStream, // , ISequentialInStream
        java.io.OutputStream outStream, // ISequentialOutStream
        long outSize, ICompressProgressInfo progress // useless_progress
    ) throws IOException {
    ...
    int CodeSpec(int curSize) throws IOException // UInt32
     {
        ...
        while (curSize > 0) {
            ...
            if (m_RangeDecoder.DecodeBit(m_IsMatchDecoders,
                ...
                LiteralDecoder.Decoder2 decoder2 = m_LiteralDecoder.GetDecoder((int) nowPos64,
                        prevByte);
    ...
    class LenDecoder {
        ...
        public void Init() {
            corner.z7.SevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_Choice);
        ...
        public int Decode(
            corner.z7.SevenZip.Compression.RangeCoder.Decoder rangeDecoder,
    ...
    class LiteralDecoder {
        ...
        class Decoder2 {
            ...
            public void Init() {
                corner.z7.SevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_Decoders);
            }
