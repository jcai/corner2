 ...
 * @private
 **/
Matter.prototype.createHTMLElement=function()
{
    ...
    this.header.style.backgroundColor="#AA66FF";
 ...
 *
 **/
Matter.prototype.setDimension=function(/*:int*/ w, /*:int*/ h )
{
 ...
 *
 **/
Matter.prototype.setTitle=function(/*:String*/ title)
{
 ...
 *
 **/
Matter.prototype.setContent=function(/*:String*/ content)
{
 ...
 * @type boolean
 **/
Matter.prototype.onDragstart = function(/*:int*/ x, /*:int*/ y)
{
 ...
 *
 **/
Matter.prototype.setCanDrag=function(/*:boolean*/flag)
{
 ...
 *
 **/
Matter.prototype.toggle=function()
{
  // collapse
  if(this.originalHeight==-1)
  {
