...
public class ShowMessageValidationDelegateTest extends BaseComponentTestCase{
	...
	public void test_write_prefix() {
		...
		replay();
		ShowMessageValidationDelegate delegate=new ShowMessageValidationDelegate();
	...
	public void test_write_message_prefix() {
        ...
        assertOutput("&nbsp;<font color=\"red\">**</font>My Error Message");
        verify();
	}
