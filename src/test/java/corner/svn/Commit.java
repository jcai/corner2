 ...
 * 
 */
public class Commit extends Assert{
    ...
    private static void commitExample() throws SVNException {
         ...
         */
        String userName = "xf";
        String userPassword = "sss";
        
        /*
         * Sample file contents.
         */
        byte[] contents = "This is a new file".getBytes();
        byte[] modifiedContents = "中文第二版.".getBytes();
        ...
        commitInfo = addDir(editor, "svnKitTest", "svnKitTest/file.txt", contents);
        ...
        commitInfo = modifyFile(editor, "svnKitTest", "svnKitTest/file.txt", contents, modifiedContents);
